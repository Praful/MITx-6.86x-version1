...
ll_first_estep = -152.16319226209848

#  After first M-step:
mu_first_mstep = np.array(
    [[2.38279095, 4.64102716, 3.73583539, 4.28989488, 2.17237899],
...
var_first_mstep = np.array([0.71489705, 0.64830186, 0.73650336, 0.85722393])
p_first_mstep = np.array([0.13810266, 0.17175435, 0.46575794, 0.22438505])
mixture_first_mstep = common.GaussianMixture(mu_first_mstep, var_first_mstep, p_first_mstep)

#  After a run
mu_first_run = np.array(
...
var_first_run = np.array([0.25,       0.25,       0.44961685, 0.27930039])
p_first_run = np.array([0.27660973, 0.35431424, 0.26752518, 0.10155086])
mixture_first_run = common.GaussianMixture(mu_first_run, var_first_run, p_first_run)
post_first_run = np.array(
...
ll_first_run = -84.98451993042474
...
X_pred = np.array(
    [[2.,        5.,         3.,        3.94554203, 1.53247395],
     ...
     [2.,        4.,         5.,        5.,        2.3116484 ],
     [2.,        5.,         4.,        4.,        2.       ]])
RMSE = 0.3152301205749675


#  def data():
    #  return X, K, mixture_first_mstep, post
